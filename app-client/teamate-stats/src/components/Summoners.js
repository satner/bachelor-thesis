                ...
                <div className="container">
                    <div style={{ marginTop: '300px' }}>
                        ...
                        <CheckboxGroup onChange={this.handleChangeRoles} >
                            <Checkbox value={'bottom'}><img src={require('../images/role-icons/Bottom_icon.png')} style={{height: '25px', width: '30px'}} alt='Bottom role'/></Checkbox>
                            <br />
                            <Checkbox value={'support'}><img src={require('../images/role-icons/Support_icon.png')} style={{height: '25px', width: '30px'}} alt='Support role'/></Checkbox>
                            <br />
                            <Checkbox value={'middle'}><img src={require('../images/role-icons/Middle_icon.png')} style={{height: '25px', width: '30px'}} alt='Middle role'/></Checkbox>
                            <br />
                            <Checkbox value={'jungle'}><img src={require('../images/role-icons/Jungle_icon.png')} style={{height: '25px', width: '30px'}} alt='Jungle role'/></Checkbox>
                            <br />
                            <Checkbox value={'top'}><img src={require('../images/role-icons/Top_icon.png')} style={{height: '25px', width: '30px'}} alt='Top role'/></Checkbox>
                            <br />
                            <Checkbox value={'specialist'}><img src={require('../images/role-icons/Specialist_icon.png')} style={{height: '25px', width: '30px'}} alt='Specialist role'/></Checkbox>
                            <br />
                        </CheckboxGroup>
