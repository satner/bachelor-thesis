...
import {Form, Input, Button, Tooltip, Icon, Select, notification, Checkbox} from 'antd';
...
const UPDATE_USER = gql`
  mutation ($id: String!, $email: String, $password: String, $languages: [String], $roles: [String]) {
    updateUserInfo(id: $id, email: $email, password: $password, languages: $languages, roles: $roles)
  }
`;
const roles = [
        ...
        <Mutation mutation={UPDATE_USER}>
          {(updateUserInfo, {data}) => (
              ...
              Languages&nbsp;
                ...
                >
                  {getFieldDecorator('languages', {initialValue: this.props.data.languages}, {
              ...
              Roles&nbsp;
                ...
                >
                  {getFieldDecorator('roles', {initialValue: this.props.data.roles}, {
